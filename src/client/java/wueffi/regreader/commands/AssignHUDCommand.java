                ...
                .then(literal("assignHUD")
                        .then(argument("name", StringArgumentType.word())
                                ...
                                .executes(context -> {
                                    ...
                                    if (Reg == null) {
                                        context.getSource().sendError(Component.nullToEmpty("Couldn't find register '" + name + "'"));
                                        return 0;
                                    }
                                    Reg.setAssignedHUD(hud);
                                    context.getSource().sendFeedback(Component.nullToEmpty("Assigned register '" + name + "' to HUD " + hud + "."));
                                    return 1;
                                })))));
    }
}