                                ...
                                .then(argument("newName", StringArgumentType.word())
                                        .executes(context -> {
                                            ...
                                            if (RegisterManager.renameRegister(oldName, newName)) {
                                                context.getSource().sendFeedback(Component.nullToEmpty("Renamed register '" + oldName + "' to '" + newName + "'"));
                                            } else {
                                                context.getSource().sendError(Component.nullToEmpty("Register '" + oldName + "' not found!"));
                                            }
