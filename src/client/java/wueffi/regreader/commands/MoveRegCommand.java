                        ...
                        .then(argument("name", StringArgumentType.word())
                                ...
                                .then(argument("direction", StringArgumentType.word())
                                        ...
                                        .executes(context -> {
                                            ...
                                            context.getSource().sendFeedback(Component.literal("Moved register '" + name + "' " + direction));
                                            return 1;
                                        }))
                                .then(argument("position", IntegerArgumentType.integer(0))
                                        .executes(context -> {
                                            ...
                                            context.getSource().sendFeedback(Component.literal("Moved register '" + name + "' to position " + position));
                                            return 1;
                                        })))));
    }
}